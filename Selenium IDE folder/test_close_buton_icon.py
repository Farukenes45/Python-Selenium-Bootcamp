...
class TestTestclosebutonicon():
  ...
  def test_close_buton_icon(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"username\"]").send_keys("close_icon_test")
    ...
    self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"password\"]").send_keys("close_button")
